...
$CustId = $Name[$i]['cust_id'];
$unit_id = $Name[$i]['unit_id'];

$ThisProId = $Name[$i]['pro_id'];
...
$html .= PrintContractInfo($Name[$i]);
    

$html .= "<pagebreak />"; 
$html .= '<div class="Header_H1">'.$ALang['n_con_installments_table'].'</div>';
$html .= Print_installments_table_PDF($Name[$i]);    
$html .= "<pagebreak />"; 
...
$footer .= 'Contract Number '.$Name[$i]['contract_num']." ";
$footer .= '</div>';
